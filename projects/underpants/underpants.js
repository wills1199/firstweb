...
_.partition = function(array, func2){
    ...
    _.filter(array, function(element, index, array) {
    if(func2(element, index, array) === false) {
...
// return true for every element that return true
  if(action === undefined) {
...
*/
   ...
   _.extend = function(object1,...restObject2) {
